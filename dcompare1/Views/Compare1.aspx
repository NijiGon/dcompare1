...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="d-flex justify-content-center" style="padding-top: 80px; padding-bottom: 80px;">
          ...
          <div class="">
            ...
            <div class="bg-white rounded-3 w-75 d-flex flex-column align-items-center p-2 mt-3 shadow pt-3">
              <p  id="nr" class="h6">1 TB &nbsp&nbsp&nbsp|&nbsp&nbsp&nbsp 12 GB</p>
  ...
  <div class="mt-5 d-flex" style="padding: 0% 5% 0% 3.5%;">
    ...
    <div class="d-flex flex-column justify-content-center align-items-center">
      <h2 id="nb" style="color: #6300E1;">Mulai bandingkan</h2>
      ...
      <div class="">
        ...
        <div class="border border-secondary rounded-4 bg-white p-4 mb-2 shadow" style="">
          ...
          <div class="d-flex">
            ...
            <div id="nr">
                <p><%= d.Dimension1.length %></p>
                <p><%= d.Dimension1.width %></p>
                <p><%= d.Dimension1.height %></p>
            </div>
          </div>
        </div>
        <div class="border border-secondary rounded-4 bg-white p-4 mb-2 shadow" style="">
          ...
          <div class="d-flex">
            ...
            <div id="nr">
                <p><%= d.Display1.height %></p>
                <p><%= d.Display1.width %></p>
                <p><%= d.Display1.refresh_rate %></p>
        ...
        <div class="border border-secondary rounded-4 bg-white p-4 mb-2 shadow" style="">
          ...
          <div class="d-flex">
            ...
            <div id="nr">
                ...
                <p><%= d.Graphic.wattage %></p>
                <p><%= d.Graphic.clock_speed %></p>
                <p><%= d.Graphic.vram %></p>
  ...
  <div class="ms-5 mt-3">
    ...
    <div class="embed-responsive embed-responsive-16by9">
      <iframe class="rounded-4 shadow" width="835" height="400" src="https://www.youtube.com/embed/zTDsP2P_Qfk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    </div>
  </div>
  ...
  <div class="ms-5 mt-4">
    <p id="nb" class="fs-4">Beri Ulasan Anda</p>
      <div class="bg-white shadow p-4 rounded-4 d-flex border" style="width: 85%; margin-top: -10px;">
        ...
        <div class="form w-50">
          <textarea class="form-control rounded-4" placeholder="Tulis ulasan anda..." id="floatingTextarea2" style="height: 210px"></textarea>
        </div>
        <div class="mt-5 ms-5">
          <div class="form-check">
            <input class="form-check-input" type="checkbox" value="" id="defaultCheck1">
            <label class="form-check-label" for="defaultCheck1">
              Saya telah menyetujui syarat dan ketentuan
            </label>
          </div>
          <div>
            <a id="nr" href="#">
